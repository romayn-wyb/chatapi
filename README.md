...
```bash
$ docker run -d -p 23003:23003 --env-file .env chatgpt-mirror
```

### Run with the config file

```bash
$ docker run -d -p 23003:23003 --env-file .env -v $(pwd)/config/app.config.json:/app/config/app.config.json chatgpt-mirror
```
